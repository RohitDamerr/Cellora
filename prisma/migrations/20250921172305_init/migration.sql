...
-- AddForeignKey
ALTER TABLE "public"."widgets" ADD CONSTRAINT "widgets_dashboard_id_fkey" FOREIGN KEY ("dashboard_id") REFERENCES "public"."dashboards"("id") ON DELETE CASCADE ON UPDATE CASCADE;
